...
class CodegenLoader extends AssetLoader{
  ...
  "CourseDetails": {
    ...
    "Quiz": {
      ...
      "areYouSureYouWantToExit": "هل أنت متأكد من أنك تريد الخروج من الاختبار؟",
      "youAnswersWillBeSubmitted": "سيتم تقديم إجاباتك، وستفقد فرصتك حتى تتاح الفرصة التالية."
    },
    "Video": {
...
static const Map<String,dynamic> en = {
  ...
  "CourseDetails": {
    ...
    "Quiz": {
      ...
      "areYouSureYouWantToExit": "Are you sure you want to exit the quiz?",
      "youAnswersWillBeSubmitted": "Your answers will be submitted, and you will lose your chance until the next opportunity is available."
    },
    "Video": {
      "loading": "Loading...",
      "notes": "Notes",
  ...
  "Settings": {
    ...
    "Recharge": {
      "valueShip": "Transaction value",
      "dateShip": "Date of Transaction",
      "idEmp": "Responsible employee ID",
      "numShip": "Transaction process number",
      "rechargeOperations": "Transaction operations"
    }
  },
  "Search": {
    "search": "Search",
