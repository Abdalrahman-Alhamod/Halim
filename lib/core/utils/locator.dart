...
import '../data/sources/remote/services/web_socket_service.dart';
import '../data/sources/remote/services/web_socket_service_impl.dart';
import '../../src/account_setup/data/data_sources/account_setup_local_data_source.dart';
import '../../src/account_setup/data/data_sources/account_setup_remote_data_source.dart';
import '../../src/account_setup/data/repos/account_setup_impl.dart';
import '../../src/account_setup/domain/repos/account_setup_repo.dart';
import '../../src/account_setup/presentation/manager/account_setup_cubit/account_setup_cubit.dart';
import '../../src/achievements/data/data_sources/achievements_local_data_source.dart';
import '../../src/achievements/data/data_sources/achievements_remote_data_source.dart';
import '../../src/achievements/data/repos/achievements_repo_impl.dart';
import '../../src/achievements/domain/repos/achievements_repo.dart';
import '../../src/achievements/presentation/manager/achievements_cubit/achievements_cubit.dart';
import '../../src/auth/data/data_sources/auth_local_data_source.dart';
import '../../src/auth/data/data_sources/auth_remote_data_source.dart';
...
import '../../src/chat/data/data_sources/chat_local_data_source.dart';
import '../../src/chat/data/data_sources/chat_remote_data_source.dart';
import '../../src/chat/data/repos/chat_repo_impl.dart';
import '../../src/chat/domain/repos/chat_repo.dart';
import '../../src/chat/presentation/manager/chat_cubit/chat_cubit.dart';
import '../../src/course_details/data/data_sources/course_details_local_data_source.dart';
import '../../src/course_details/data/data_sources/course_details_remote_data_source.dart';
import '../../src/course_details/data/repos/course_details_repo_impl.dart';
import '../../src/course_details/domain/repos/course_details_repo.dart';
...
import '../../src/home/data/data_sources/home_local_data_source.dart';
import '../../src/home/data/data_sources/home_remote_data_source.dart';
import '../../src/home/data/repos/home_repo_impl.dart';
import '../../src/home/domain/repos/home_repo.dart';
import '../../src/home/presentation/manager/home_cubit/home_cubit.dart';
import '../../src/mentor_details/data/data_sources/mentor_details_local_data_source.dart';
import '../../src/mentor_details/data/data_sources/mentor_details_remote_data_source.dart';
import '../../src/mentor_details/data/repos/mentor_details_repo_impl.dart';
import '../../src/mentor_details/presentation/manager/mentor_details_cubit/mentor_details_cubit.dart';
import '../../src/my_courses/data/data_sources/my_courses_local_data_source.dart';
import '../../src/my_courses/data/data_sources/my_courses_remote_data_source.dart';
import '../../src/my_courses/data/repos/my_courses_repo_impl.dart';
import '../../src/my_courses/domain/repos/my_courses_repo.dart';
import '../../src/my_courses/presentation/manager/my_courses_cubit/my_courses_cubit.dart';
import '../../src/profile_settings/data/data_sources/profile_settings_local_data_source.dart';
import '../../src/profile_settings/data/data_sources/profile_settings_remote_data_source.dart';
import '../../src/profile_settings/data/repos/profile_settings_repo_impl.dart';
import '../../src/profile_settings/domain/repos/profile_settings_repo.dart';
import '../../src/profile_settings/presentation/manager/cubit/profile_settings_cubit.dart';
import '../../src/search/data/data_sources/search_local_data_source.dart';
import '../../src/search/data/data_sources/search_remote_data_source.dart';
import '../../src/search/data/repos/search_repo_impl.dart';
import '../../src/search/domain/repos/search_repo.dart';
...
import '../../src/store/data/data_sources/store_local_data_source.dart';
import '../../src/store/data/data_sources/store_remote_data_source.dart';
import '../../src/store/data/repos/store_repo_impl.dart';
import '../../src/store/domain/repos/store_repo.dart';
