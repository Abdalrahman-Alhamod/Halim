...
class AccountSetupState with _$AccountSetupState {
  ...
  const factory AccountSetupState.failure(NetworkExceptions? networkException) =
      _Failure;
  const factory AccountSetupState.success(
      StudentInfomationsModel data, String? message) = _Success;
}
