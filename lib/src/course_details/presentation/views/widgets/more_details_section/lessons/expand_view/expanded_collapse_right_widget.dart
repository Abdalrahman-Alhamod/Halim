...
class ExpandedCollapseRightWidget extends StatefulWidget {
  ...
  _ExpandedCollapseOpenOrderWidgetState createState() =>
      _ExpandedCollapseOpenOrderWidgetState();
}

class _ExpandedCollapseOpenOrderWidgetState
    extends State<ExpandedCollapseRightWidget>
                ...
                child: Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: Container(
                      ...
                      height: 16,
                      child: _isExpanded
                          ? SvgPicture.asset(widget.collapseImage!)
                          : SvgPicture.asset(widget.expandImage!),
                    ),
                  ),
                ),
              ),
